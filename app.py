...
log = logging.getLogger("true-stream-v7")
...
def telegram_bot_file_url(file_id):
    ...
    req = urllib.request.Request(url, headers={"User-Agent": "TrueStream/7"}, method="GET")
